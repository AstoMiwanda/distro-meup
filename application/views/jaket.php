...
<?php require_once 'template/left_navbar.php' ?>
  ...
  <div class="content-wrapper">
    ...
    <div style="display: flex; align-items: center;">
      <a href="<?=base_url()?>Jaket/ViewAdd" type="button" class="btn btn-success">Tambah</a>
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">
        Upload Excel
      </button>
      <a href="<?=base_url()?>Jaket/ExportJaket" type="button" class="btn btn-success">Download Data</a>
    </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Table Stock Jaket</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            	...
            	{ $i++;?>
                  ...
                  <td><?php echo $value->harga;?></td>
            			<?php foreach ($user->result() as $value_user) {
            				if ($value_user->level == 'Admin') { ?>
            					<td><a href="<?=base_url()?>Jaket/ViewEdit/<?php echo $value->id; ?>"><img src="<?=base_url()?>assets/img/edit.svg"></a></td>
            					<td><a href="<?=base_url()?>Jaket/Delete/<?php echo $value->id; ?>"><img src="<?=base_url()?>assets/img/delete.svg"></a></td>
            			<?php }} ?>
            			</tr>
            	<?php }?>
                </tfoot>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="import_form" enctype="multipart/form-data" action="<?php echo base_url(); ?>Jaket/ImportExcel">
