...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?=base_url()?>Celana"><i class="fa fa-circle-o"></i> Celana</a></li>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <a href="<?=base_url()?>Celana/ViewAdd" type="button" class="btn btn-block btn-success">Tambah</a>
