...
<div id="input">
    <div class="header">Input Data Tas</div>
    <center>
        <table>
            <form action="<?=base_url()?>Tas/AddAction" method="post">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?=base_url()?>Tas"><i class="fa fa-circle-o"></i> Tas</a></li>
