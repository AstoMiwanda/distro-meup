...
<script>
  $(function () {
    ...
    var January = jArray['January'];
    var February = jArray['February'];
    var March = jArray['March'];
    var April = jArray['April'];
    var May = jArray['May'];
    var June = jArray['June'];
    var July = jArray['July'];
