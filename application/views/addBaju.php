                        ...
                        <form id="tambah_barang" action="<?=base_url()?>Baju/AddAction" method="post" class="form-horizontal">
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input id="ukuran_barang" type="text" class="form-control" name="ukuran" placeholder="Ukuran" required>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input id="stock_barang" type="text" class="form-control" name="stock" placeholder="Stock" required>
                              </div>
                            </div>
                          </div>
                          <!-- /.box-body -->
